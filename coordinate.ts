 ...
 * @example getCoordinates(37.7749, -122.4194, 1000, 0.001); // 좌표 리스트 반환
 */
...
console.log(centerPoint(points)); // { x: 1, y: 1 }
console.log(getCoordinates(37.7749, -122.4194, 1000, 0.001));
